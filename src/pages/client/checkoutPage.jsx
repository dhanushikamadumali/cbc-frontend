            ...
            <div className="w-[500px]">
                {
                    cart.map((item , index)=>{
                        return(
                            ...
                            <button className="absolute right-[-50px] bg-red-500 w-[40px] h-[40px] rounded-full text-white flex justify-center items-center shadow cursor-pointer" onClick={
                                ()=>{
                                    // ape current product eka arenna anek dewal tika dagannaawa 
                            ...
                            <img src={item.image} className="h-full aspect-square object-cover "/>
                                    ...
                                    <div className="h-full w-[100px] flex justify-center items-center">
                                        <button className="text-2xl w-[30px] h-[30px] bg-black text-white rounded-full flex justify-center items-center cursor-pointer mx-[5px]" onClick={
                                            ()=>{
                                                // parana cart itms tika
                                               const newCart = cart
                                            //    newcart eken adala index ekata adala quntity eka adu wenna ona
                                               newCart[index].quantity -= 1
                                            //   newcart eke quntity eka 0 ta wada adunam 1 karanna
                ...
                <h1 className="w-[100px] text-xl  text-end pr-2 border-b-[4px] border-double">{getTotal().toFixed(2)}</h1>
                 ...
                 <div className="w-full flex justify-end">
                  <h1 className="w-[100px] text-xl  text-end pr-2">Name</h1>    
                    <input className="w-[200px] text-xl border-b-[2px] text-end pr-2"
                    value={name}
                ...
                <div className="w-full flex justify-end mt-4">
                    <button className="w-[170px] text-xl text-center bg-pink-400 shadow text-white h-[40px] rounded-lg cursor-pointer"
